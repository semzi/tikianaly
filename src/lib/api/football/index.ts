...
/**
 * Fetch league logo by ID
 * @param leagueId - The ID of the league
 */
export const getLeagueLogoById = async (leagueId: string | number) => {
  const response = await apiClient.get(
    `/api/v1/football/leagues/id/${leagueId}`,
  );
  return response.data;
...
/**
 * Fetch team logo by ID
 * @param teamId - The ID of the team
 */
export const getTeamLogoById = async (teamId: string | number) => {
  const response = await apiClient.get(
    `/api/v1/football/teams/id/${teamId}`,
  );
  return response.data;
};

/**
 * Fetch player image by ID
 * @param playerId - The ID of the player
 */
export const getPlayerImageById = async (playerId: string | number) => {
  const response = await apiClient.get(
    `/api/v1/football/players/id/${playerId}`,
  );
  return response.data;
