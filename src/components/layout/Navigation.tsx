  ...
  return (
    <div className="flex md:hidden z-1000 justify-around backdrop-blur-lg px-2 fixed bottom-0 pt-3 pb-5 dark:bg-black/40 bg-white/50 w-full b">
      <NavLink
        to="/"
        className={({ isActive }) =>
          `flex  dark:text-smoke-200 items-center flex-col relative${isActive ? " text-brand-primary" : ""}`
        }
      >
        {({ isActive }) => (
          <>
            {isActive && (
              <span className="absolute top-[-10px] h-[2px] w-10 bg-brand-primary"></span>
            )}
            {isActive ? (
              <HomeIconSolid className="h-7 w-7" />
            ) : (
              <HomeIconOutline className="text-neutral-n4 dark:text-smoke-200 h-7 w-7" />
            )}
      ...
      >
        {({ isActive }) => (
          <>
            ...
            {isActive ? (
              <TrophyIconSolid className="h-7 w-7" />
            ) : (
              <TrophyIconOutline className="text-neutral-n4 dark:text-smoke-200 h-7 w-7" />
            )}
      ...
      >
        {({ isActive }) => (
          <>
            ...
            {isActive ? (
              <BookOpenIconSolid className="h-7 w-7" />
            ) : (
              <BookOpenIconOutline className="text-neutral-n4 dark:text-smoke-200 h-7 w-7" />
            )}
      ...
      >
        {({ isActive }) => (
          <>
            ...
            {isActive ? (
              <UserCircleIconSolid className="h-7 w-7" />
            ) : (
              <UserCircleIconOutline className="text-neutral-n4 dark:text-smoke-200 h-7 w-7" />
            )}
